...
export function initRoastr(character = "Rick") {
...
function getConsoleRoast(method, character) {
    const consoleRoasts = {
        Rick: {
    ...
    const roasts = consoleRoasts[character][method] || consoleRoasts[character]["log"];
